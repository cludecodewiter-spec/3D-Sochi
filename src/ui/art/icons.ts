...
export const VENUE_GLYPHS: Record<VenueKey, Glyph> = {
  ...
  // 赌厅 — 一张牌加两颗骰子的点
  casino: group(
    lined('M6.6 4.2 h8.4 a1.6 1.6 0 0 1 1.6 1.6 v12.4 a1.6 1.6 0 0 1-1.6 1.6 H6.6 a1.6 1.6 0 0 1-1.6-1.6 V5.8 a1.6 1.6 0 0 1 1.6-1.6 Z', 1.8),
    lined('M10.8 8.2 l2.4 3.2 -2.4 3.2 -2.4-3.2 Z', 1.4),
    lined('M17.6 15.4 h2.8 M17.6 18.2 h2.8', 1.4),
  ),
  // 帮派据点 — 门口那两个人
  den: group(
    lined('M4.4 20.4 v-3.6 a3.2 3.2 0 0 1 3.2-3.2 h1.6 a3.2 3.2 0 0 1 3.2 3.2 v3.6', 1.8),
    lined('M8.4 6.6 a2.8 2.8 0 1 0 0 5.6 a2.8 2.8 0 1 0 0-5.6', 1.6),
    lined('M13.6 20.4 v-3.2 a3 3 0 0 1 3-3 h1 a3 3 0 0 1 3 3 v3.2', 1.4),
    lined('M17.2 8.2 a2.4 2.4 0 1 0 0 4.8 a2.4 2.4 0 1 0 0-4.8', 1.2),
  ),
}
